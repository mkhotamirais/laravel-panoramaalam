        ...
        <div class="container max-w-screen-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mt-8">
                <div
                    ...
                    <p class="mb-8 text-gray-600">Sewa mobil mudah, cepat, dan hemat! Pilih kendaraan favorit Anda untuk
                        perjalanan nyaman bersama kami.</p>
                    <a href="{{ route('sewa-mobil') }}"
                        class="font-semibold rounded-full px-5 py-3 bg-orange-500 hover:bg-orange-600 transition text-white">Cek
                        Detail</a>
                </div>
                <div
                    class="p-8 leading-relaxed border-b overflow-hidden shadow-md hover:shadow-xl transition rounded-lg">
                    ...
                    <p class="mb-8 text-gray-600">Jelajahi destinasi impian Anda dengan paket wisata terbaik! Nikmati
                        liburan seru dan hemat bersama kami.</p>
