        ...
        <div class="bg-gradient-to-t from-black/40 to-black/60 min-h-[40vh] flex flex-col items-center justify-center">
            <div class="container text-white">
                <div class="space-y-8 max-w-screen-sm leading-relaxed">
                    <h1 class="text-4xl lg:text-5xl font-semibold capitalize">{{ $blogCategory->name }}'s Blogs
    ...
    @if ($search)
        <div class="container py-6">
            <p class="text-xl">
                ...
                Semua blog <span class="capitalize">{{ $blogCategory->name }}</span> ( {{ $categoryBlogs->total() }} )
            </p>
        </div>
    @endif
