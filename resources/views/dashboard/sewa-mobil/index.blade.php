...
<x-authlayout>
    <div class="container py-4">
        ...
        {{-- <h2 class="text-2xl font-semibold mt-3 py-2">Your Car Reental ({{ $myBlogs->total() }})</h2> --}}
        <h2 class="text-2xl font-semibold mt-3 py-2">Your Car Reental (8)</h2>
        <a href="{{ route('sewas.create') }}"
        ...
        {{-- <h1 class="text-2xl font-semibold mt-3 py-2">Semua Blog Wisata ({{ $blogs->total() }})</h1> --}}
        <h1 class="text-2xl font-semibold mt-3 py-2">Semua Blog Wisata (7)</h1>
